...
func TestNewTokenCounter_HeuristicRouting(t *testing.T) {
	tests := []struct {
		...
		{name: "gpt-4o", modelName: "gpt-4o", expectedRatio: runesPerTokenQWEN},
		{name: "gpt-4.1-mini", modelName: "gpt-4.1-mini", expectedRatio: runesPerTokenQWEN},
		{name: "gpt-4-turbo", modelName: "gpt-4-turbo", expectedRatio: runesPerTokenDeepSeek},
		{name: "gpt-3.5-turbo", modelName: "gpt-3.5-turbo", expectedRatio: runesPerTokenDeepSeek},
		{name: "claude-sonnet", modelName: "claude-sonnet", expectedRatio: runesPerTokenQWEN},
		{name: "glm-5-plus", modelName: "glm-5-plus", expectedRatio: runesPerTokenQWEN},
		{name: "glm5-air", modelName: "glm5-air", expectedRatio: runesPerTokenQWEN},
		{name: "doubao-pro", modelName: "doubao-pro", expectedRatio: runesPerTokenQWEN},
		{name: "hunyuan-lite", modelName: "hunyuan-lite", expectedRatio: runesPerTokenQWEN},
		{name: "minimax-01", modelName: "minimax-01", expectedRatio: runesPerTokenQWEN},
		{name: "llama-3", modelName: "llama-3", expectedRatio: runesPerTokenDeepSeek},
		{name: "yi-large", modelName: "yi-large", expectedRatio: runesPerTokenDeepSeek},
